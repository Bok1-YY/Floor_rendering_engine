...
ROOT=Path(__file__).resolve().parents[1];SOURCE=ROOT/'data/goal_loop_v2/references/1308/reference-coordinate-authorized-v21.json';MANIFEST=ROOT/'reports/targeted_cut_adjudication_20260902/targeted-cut-adjudication.json';RESULTS=Path(r'C:/Users/1_1/Desktop/goal_loop_v2_1308_fal_targeted_cut_20260902')
