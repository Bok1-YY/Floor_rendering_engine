...
本轮构建发现部分 Microsoft Visual C++ DLL 未由 Nuitka 内置。Windows 可执行文件需要当前 v14 x64 运行库，发行附件提供官方入口，未在本机额外安装。安装条件与支持系统见[微软文档](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist)。
