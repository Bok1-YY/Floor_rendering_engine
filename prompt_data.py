...
TECH_DICT = {
    ...
    "圆弧倒角 (Pressed Bevel)": (
        "A continuous, NEAR-SEAMLESS wood floor whose ONLY edge treatment is a gently ROUNDED-OVER plank edge: "
        "each plank's former sharp right-angle top corner is eased into a smooth, soft, CONVEX arc (a gentle quarter-round / pillowed edge). "
        "This is fundamentally a SEAMLESS surface — the wood grain, color and finish flow continuously from one plank into the next, "
        "with NO dark joint line, NO V-groove, NO recessed valley or channel, NO gap, NO grout, NO shadow groove. "
        "Where two planks meet, their two rounded edges form an EXTREMELY SOFT, shallow, barely-perceptible transition. "
        "It must read mainly as a faint, gentle HIGHLIGHT skimming along the rounded lips (the curved edge catching the light), "
        "with at most a whisper of soft, diffuse self-shadow — never a drawn line, never a dark line, never black or grey. "
        "The curve is BROAD, FLAT and GRADUAL — a soft easing of the edge — NOT a pronounced bevel, NOT a deep U-dip, NOT a sharp chamfer. "
        "Think of a high-end Coretec / luxury vinyl plank: the seams are so soft they almost disappear, "
